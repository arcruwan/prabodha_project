...
@section('content')
    <div class="wm-main-banner">
        ...
        <div class="wm-banner-two">
            <div class="wm-banner-two-layer">
                ...
                <img src="extra-images/banner-view2-1.jpg" alt="">
                <div class="wm-caption-two">
                    <div class="container">
                        <div class="wm-caption-two-inner">
                            <h1>Warmly Welcome to the Best Way Academy</h1>

                            <p>Emphasizing the importance of a positive mindset, resilience, perseverance, and a
                                growth-oriented attitude toward learning.</p>
                            <div class="clearfix"></div>
                            <a href="#"><span>About Us</span></a>
                        </div>
                    </div>
                </div>
                <!-- <div class="wm-banner-adds">
                    <ul>
                        <li>
                            <div class="wm-banner-addswrap">
                                <div class="wm-banner-adds-inner">
                                    <time datetime="2008-02-14 20:00"><i class="wmicon-time2"></i> 12 April, 2016</time>
                                    <h2>Philharmonia No. 6</h2>
                                    <p>Sponsored by Arlyne and Myron Weinberg, the Lynn Philharmonia takes the stage once again.</p>
                                </div>
                                <span>11 Gateway Avenue, Los Angeles, CA</span>
            ...
            <div class="wm-banner-two-layer">
                <span class="wm-bannertwo-transparent"></span>
                <img src="extra-images/banner-view2-2.jpg" alt="">
                <div class="wm-caption-two">
                    <div class="container">
                        <div class="wm-caption-two-inner">
                            <h1>"Learning is a Journey, Not a Destination."</h1>
                            <p>Providing guidance on setting achievable goals, creating study plans, and outlining
                                steps toward academic or personal growth.</p>
                            <div class="clearfix"></div>
                            <a href="#"><span>About Us</span></a>
                        </div>
                    </div>
                ...
                <div class="wm-banner-adds">
                    <ul>
                        <li>
                            <div class="wm-banner-addswrap">
                                <div class="wm-banner-adds-inner">
                                    <time datetime="2008-02-14 20:00"><i class="wmicon-time2"></i> 12 April,
                                        2016</time>
                                    <h2>Philharmonia No. 6</h2>
                                    <p>Sponsored by Arlyne and Myron Weinberg, the Lynn Philharmonia takes the stage
                                        once again.</p>
                                </div>
                                <span>11 Gateway Avenue, Los Angeles, CA</span>
                                <div class="wm-banner-adds-inner"> <a href="#"
                                        class="wm-classic-button wm-bgcolor-two">See Event</a> </div>
                            </div>
                        </li>
                        <li>
                            <div class="wm-banner-addswrap">
                                <div class="wm-banner-adds-inner">
                                    <time datetime="2008-02-14 20:00"><i class="wmicon-time2"></i> 10 April,
                                        2016</time>
                                    <h2>Dean's Showcase Event</h2>
                                    <p>Music students who've been selected by faculty to participate in the Dean's
                                        Showcase.</p>
                                </div>
                                <span>2013 Webster Street Woodbridge, NJ 07095</span>
                                <div class="wm-banner-adds-inner"> <a href="#"
            ...
            <div class="wm-banner-two-layer">
                <span class="wm-bannertwo-transparent"></span>
                <img src="extra-images/banner-view2-3.jpg" alt="">
                <div class="wm-caption-two">
                    <div class="container">
                        <div class="wm-caption-two-inner">
                            <h1>A positive attitude enhances the learning experience.</h1>
                            <p>Showcasing role models or mentors who have made a significant impact in education and
                                emphasizing the value of mentorship in one's educational journey.</p>
                            <div class="clearfix"></div>
                            <a href="#"><span>About Us</span></a>
                        </div>
                    </div>
    ...
    <div class="wm-main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="wm-courses wm-coursespopular-list">
                            <ul class="row">
                                <li class="col-md-3">
                                    <figure><a href="#"><img src="extra-images/popular-courses-1.jpg"
                                                alt=""></a>
                                        <figcaption><a href="#"><span>See course</span></a></figcaption>
                                    </figure>
                                    <div class="coursespopular-list-text">
                                        <div class="list-courses-thumb"> <img
                                                src="extra-images/popular-courses-thumb-1.jpg" alt=""> <a
                                                href="#" class="wm-color-two">Shelly T.
                                                Forrester</a> </div>
                                ...
                                <li class="col-md-3">
                                    <figure><a href="#"><img src="extra-images/popular-courses-2.jpg"
                                                alt=""></a>
                                        <figcaption><a href="#"><span>See course</span></a></figcaption>
                                    </figure>
                                    <div class="coursespopular-list-text">
                                        <div class="list-courses-thumb"> <img
                                                src="extra-images/popular-courses-thumb-2.jpg" alt=""> <a
                                                href="#" class="wm-color-two">Guillermo L.
                                                Kelly</a> </div>
                                ...
                                <li class="col-md-3">
                                    <figure><a href="#"><img src="extra-images/popular-courses-3.jpg"
                                                alt=""></a>
                                        <figcaption><a href="#"><span>See course</span></a></figcaption>
                                    </figure>
                                    <div class="coursespopular-list-text">
                                        <div class="list-courses-thumb"> <img
                                                src="extra-images/popular-courses-thumb-3.jpg" alt=""> <a
                                                href="#" class="wm-color-two">Elizabeth
                                                Anderson</a> </div>
                                ...
                                <li class="col-md-3">
                                    <figure><a href="#"><img src="extra-images/popular-courses-4.jpg"
                                                alt=""></a>
                                        <figcaption><a href="#"><span>See course</span></a></figcaption>
                                    </figure>
                                    <div class="coursespopular-list-text">
                                        <div class="list-courses-thumb"> <img
                                                src="extra-images/popular-courses-thumb-4.jpg" alt=""> <a
                                                href="#" class="wm-color-two">Quintin L. Erickson</a> </div>
        ...
        <!--// Main Section \\-->
        <div class="wm-main-section wm-parallex-full">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="wm-parallex">
                            <h2>Conservatory University Album</h2>
                            <span>Conservatory album produced projects for students!</span>
                            <a class="wm-classic-button wm-bgcolor-two" href="#"><i class="wmicon-shop"></i> Start
                                Shopping</a>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="wm-courses wm-modren-courses">
                        <ul>
                            <li class="col-md-3">
                                <figure><a href="#"><img src="extra-images/modren-courses-1.jpg"
                                            alt=""></a>
                                    <h2 class="wm-course-captiontitle">Our Instructors</h2>
                                    <figcaption>
                                        <h3><a href="#">Our Instructors</a></h3>
                                        <p>Our two-year Conservatory education prepares our graduates with the power
                                            to impact audiences.</p>
                                        <a href="#" class="wm-course-see-btn">See all</a>
                                    </figcaption>
                                </figure>
                            </li>
                            <li class="col-md-3">
                                <figure><a href="#"><img src="extra-images/modren-courses-2.jpg"
                                            alt=""></a>
                                    <h2 class="wm-course-captiontitle">Conservatory Courses</h2>
                                    <figcaption>
                            ...
                            <li class="col-md-3">
                                <figure><a href="#"><img src="extra-images/modren-courses-3.jpg"
                                            alt=""></a>
                                    <h2 class="wm-course-captiontitle">Our Facility</h2>
                                    <figcaption>
                            ...
                            <li class="col-md-3">
                                <figure><a href="#"><img src="extra-images/modren-courses-4.jpg"
                                            alt=""></a>
                                    <h2 class="wm-course-captiontitle">FAQ</h2>
                                    <figcaption>
                                        <h3><a href="#">FAQ</a></h3>
                                        <p>Our two-year Conservatory education prepares our graduates with the power
                                            to impact audiences.</p>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="wm-upcoming-event-slider">
                            <div class="wm-upcoming-event-layer">
                                <div class="wm-banner-addswrap">
                                    <div class="wm-banner-adds-inner">
                                        <time datetime="2008-02-14 20:00"><i class="wmicon-time2"></i> 24 April,
                                            2016</time>
                                        <h2>Convocation Recital</h2>
                                        <p>We are pleased to offer a live-stream of this concert. The concert will
                                            not be archived for future viewing.</p>
                                    </div>
                            ...
                            <div class="wm-upcoming-event-layer">
                                <div class="wm-banner-addswrap">
                                    <div class="wm-banner-adds-inner">
                                        <time datetime="2008-02-14 20:00"><i class="wmicon-time2"></i> 22 April,
                                            2016</time>
                                        <h2>Percussion Ensemble</h2>
                                        <p>Performing contemporary works for percussion and marimba ensemble with a
                                            diverse array.</p>
                                    </div>
                                ...
                                <div class="wm-banner-addswrap">
                                    <div class="wm-banner-adds-inner">
                                        <time datetime="2008-02-14 20:00"><i class="wmicon-time2"></i> 10 April,
                                            2016</time>
                                        <h2>Dean's Showcase Event</h2>
                                        <p>Music students who've been selected by faculty to participate in the
                                            Dean's Showcase.</p>
                                    </div>
                                    <span>2013 Webster Street Woodbridge, NJ 07095</span>
                                    <div class="wm-banner-adds-inner"> <a href="#"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="wm-service wm-plain-service">
                            <ul class="row">
                                <li class="col-md-3">
                                    <span class="wm-color-two"><i class="wmicon-medical2"></i> <small
                                            class="word-count">100</small></span>
                                    <h5><a href="#">Dental Insurance</a></h5>
                                    <p>100% coverage for diagnostic and preventive care.</p>
                                </li>
                                <li class="col-md-3">
                                    <span class="wm-color-two"><i class="wmicon-glasses"></i> <small
                                            class="word-count">12</small></span>
                                    <h5><a href="#">Voluntary Vision</a></h5>
                                    <p>Our healthcare group insurance purchase the vision insurance.</p>
                                </li>
                                <li class="col-md-3">
                                    <span class="wm-color-two"><i class="wmicon-technology2"></i> <small
                                            class="word-count">34</small></span>
                                    <h5><a href="#">Flexible Spending Plan</a></h5>
                                    <p>Allows the employee to establish a Flexible Spending account</p>
                                </li>
                                <li class="col-md-3">
                                    <span class="wm-color-two"><i class="wmicon-medical"></i> <small
                                            class="word-count">56</small></span>
                            ...
                            <ul class="row">
                                <li class="col-md-12">
                                    <div class="wm-latest-news-wrap">
                                        <figure><a href="#"><img src="extra-images/latest-news-thumb-1.jpg"
                                                    alt=""></a>
                                ...
                                <li class="col-md-12">
                                    <div class="wm-latest-news-wrap">
                                        <figure><a href="#"><img src="extra-images/latest-news-thumb-2.jpg"
                                                    alt=""></a>
                                            <figcaption><a href="#" class="wmicon-arrows3"></a></figcaption>
                                        </figure>
                                        <div class="wm-latestnews-text">
                                ...
                                <li class="col-md-12">
                                    <div class="wm-latest-news-wrap">
                                        <figure><a href="#"><img src="extra-images/latest-news-thumb-3.jpg"
                                                    alt=""></a>
                                            <figcaption><a href="#" class="wmicon-arrows3"></a></figcaption>
                                        </figure>
                                        <div class="wm-latestnews-text">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="wm-thumb-testimonial">
                            <div class="wm-thumb-testimonial-layer">
                                <figure><a href="#"><img src="extra-images/testimonial-slider-1.jpg"
                                            alt=""></a></figure>
                                <div class="thumb-testimonial-text">
                                    <h4><a href="#">Jennifer Cameron</a></h4>
                                    <span class="wm-color-two">-Guitar Student</span>
                                    <p>I just wanted to thank you for the beautiful guides! We are in the midst of
                                        Family Weekend check-in and have had RAVE from our parents!</p>
                                </div>
                            </div>
                            <div class="wm-thumb-testimonial-layer">
                                <figure><a href="#"><img src="extra-images/testimonial-slider-2.jpg"
                                            alt=""></a></figure>
                                <div class="thumb-testimonial-text">
